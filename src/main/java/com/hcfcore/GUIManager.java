...
public class GUIManager {
    ...
    public GUIManager(HCFCore plugin) {
        ...
        this.airdropEditorGUI = new AirdropEditorGUI(plugin);
        this.kitEditorGUI = new KitEditorGUI(plugin);
        this.kothEditorGUI = new KothEditorGUI(plugin);
        this.villagerEditorGUI = new VillagerEditorGUI(plugin);
    }

    public void register() {

        plugin.getServer().getPluginManager()
                .registerEvents(editorGUI, plugin);

        plugin.getServer().getPluginManager()
                .registerEvents(airdropEditorGUI, plugin);

        plugin.getServer().getPluginManager()
                .registerEvents(kitEditorGUI, plugin);

        plugin.getServer().getPluginManager()
                .registerEvents(kothEditorGUI, plugin);

        plugin.getServer().getPluginManager()
                .registerEvents(villagerEditorGUI, plugin);
    }
